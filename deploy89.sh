...
scp build/libs/air-share-0.0.1-SNAPSHOT.jar grow@file.bosch-smartlife.com:/media/data/app/air-share
scp asset/shell/start89.sh grow@file.bosch-smartlife.com:/media/data/app/air-share
ssh grow@file.bosch-smartlife.com  sh /media/data/app/air-share/start89.sh
