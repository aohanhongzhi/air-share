...
nohup /media/data/app/graalvm-jdk-21+35.1/bin/java  -Dfile.encoding=utf-8 -Duser.timezone=GMT+08 -jar /media/data/app/air-share/air-share-0.0.1-SNAPSHOT.jar --spring.profiles.active=prod -Xmx1G -Xms1G -server -XX:+UseG1GC -XX:+HeapDumpOnOutOfMemoryError >> /media/data/app/air-share/air-share.log  2>&1 &
